...
public:
   ...
   /**
    ...
    void setTessellationEvaluationShader(string &tessellationEvaluationCode)
    {
        ...
        {
            // if an error is found, print the log (even if not in debug mode)
            std::cerr << "Error compiling tessellation evaluation shader: " << tessellationEvaluationShaderPath << std::endl;
    ...
    void setGeometryShader(string &geometryShaderCode)
    {
        ...
        {
            // if an error is found, print the log (even if not in debug mode)
            std::cerr << "Error compiling geometry shader: " << geometryShaderPath << std::endl;
    ...
    void setFragmentShader (string& fragmentShaderCode)
    {
        ...
        if (result != GL_TRUE)
        {
            std::cerr << "Error compiling fragment shader: " << fragmentShaderPath << std::endl;
    ...
    void setComputeShader (string& computeShaderCode)
    {
        ...
        if (result != GL_TRUE)
        {
            std::cerr << "Error compiling compute shader: " << computeShaderPath << std::endl;
