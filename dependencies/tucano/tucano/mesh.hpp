...
protected:
	 ...
	 */
	float* mapAttrib( const string name, const unsigned long offset, const unsigned long length )
	{
...
public:
	 ...
	 */
	void reserveVertices( const int element_size, const unsigned long size )
	{
	 ...
	 * @param size Number of attribute values (size of the vertex attribute array).
	 */
    void reserveNormals( const unsigned long size )
	{
	 ...
	 * @param size Number of attribute values (size of the vertex attribute array).
	 */
    void reserveColors( const int element_size, const unsigned long size )
	{
		numberOfNormals = size;
	 ...
	 * @param size Number of attribute values (size of the vertex attribute array).
	 */
    void reserveTexCoords( const unsigned long size )
	{
	 ...
	 */
	void reserveIndices( const unsigned long size )
	{
		numberOfElements = size;
		glGenBuffers( 1, &index_buffer_id );
		glBindBuffer( GL_ELEMENT_ARRAY_BUFFER, index_buffer_id );
		glBufferData( GL_ELEMENT_ARRAY_BUFFER, size * sizeof( unsigned int ), NULL, GL_DYNAMIC_DRAW );
	}
	 ...
	 * @return A pointer to the mapped range.
	 */
    float* mapVertices( const unsigned long offset, const unsigned long length )
	{
	 ...
	 * @return A pointer to the mapped range.
	 */
	float* mapNormals( const unsigned long offset, const unsigned long length )
	{
	 ...
	 * @return A pointer to the mapped range.
	 */
	float* mapColors( const unsigned long offset, const unsigned long length )
	{
	 ...
	 * @return A pointer to the mapped range.
	 */
	float* mapTexCoords( const unsigned long offset, const unsigned long length )
	{
	 ...
	 * @return A pointer to the mapped range.
	 */
	unsigned int* mapIndices( const unsigned long offset, const unsigned long length )
	{
		numberOfElements = length;
		glBindBuffer( GL_ELEMENT_ARRAY_BUFFER, index_buffer_id );
		unsigned int* ptr = ( unsigned int* ) glMapBufferRange( GL_ELEMENT_ARRAY_BUFFER, offset * sizeof( unsigned int ), length * sizeof( unsigned int ),
												GL_MAP_WRITE_BIT | GL_MAP_INVALIDATE_RANGE_BIT );
		return ptr;
	}
    ...
    */
	 ...
	 * @return Pointer to created attribute.
	 */
    VertexAttribute* createAttribute( const string name, const int element_size, const unsigned long size )
	{
